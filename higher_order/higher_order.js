...
var talkToUser = function (prompts,'a string',promptType)

// Use this to test your talkToUser function:

var funFacts (if promptType === 'log'

console.log ("A moment is a medieval unit of time equal to 1.5 minutes or 1/40 of an hour.",
